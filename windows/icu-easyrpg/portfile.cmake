...
vcpkg_download_distfile(
    ...
    SHA512 3e08025e81111113397ec60b8622b0cd3413393b81030d7dc687c92fc2531be16249569257a65435526284b986372f569d52ff97bca7f37aa73ca343ed10f3e4
)
...
# EASYRPG CUSTOM
list(APPEND CONFIGURE_OPTIONS --with-data-packaging=static)
# EASYRPG END
...
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/icu-config" "${CURRENT_INSTALLED_DIR}" "`dirname $0`/../../../" IGNORE_UNCHANGED)
vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin/icu-config" "${CURRENT_HOST_INSTALLED_DIR}" "`dirname $0`/../../../../${_HOST_TRIPLET}/" IGNORE_UNCHANGED)
