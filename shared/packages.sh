...
HARFBUZZ_URL="https://github.com/harfbuzz/harfbuzz/releases/download/14.4.0/harfbuzz-14.4.0.tar.xz"
...
EXPAT_URL="https://github.com/libexpat/libexpat/releases/download/R_2_8_4/expat-2.8.4.tar.bz2"
...
LIBXMP_LITE_URL="https://github.com/libxmp/libxmp/releases/download/libxmp-4.7.3/libxmp-lite-4.7.3.tar.gz"
LIBXMP_LITE_ARGS="-DBUILD_STATIC=ON -DBUILD_SHARED=OFF"
LIBXMP_LITE_DIR="libxmp-lite-4.7.3"
...
FLUIDSYNTH_URL="https://github.com/FluidSynth/fluidsynth/archive/refs/tags/v2.6.0.tar.gz"
...
FLUIDSYNTH_DIR="fluidsynth-2.6.0"
...
SDL3_URL="https://libsdl.org/release/SDL3-3.4.16.tar.gz"
SDL3_ARGS="-DSDL_TEST_LIBRARY=OFF -DSDL_EXAMPLES=OFF"
SDL3_DIR="SDL3-3.4.16"
