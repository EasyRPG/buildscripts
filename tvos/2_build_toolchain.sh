...
function build() {
	...
	install_lib_cmake $FLUIDSYNTH_DIR $FLUIDSYNTH_ARGS -Dosal=embedded -DCMAKE_MACOSX_BUNDLE=OFF -Denable-framework=OFF -Denable-coreaudio=OFF -Denable-coremidi=OFF
