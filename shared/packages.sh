...
HARFBUZZ_URL="https://github.com/harfbuzz/harfbuzz/releases/download/10.0.1/harfbuzz-10.0.1.tar.xz"
HARFBUZZ_ARGS="-Dfreetype=enabled -Dtests=disabled -Dutilities=disabled" # TODO disable subset
HARFBUZZ_DIR="harfbuzz-10.0.1"
...
EXPAT_URL="https://github.com/libexpat/libexpat/releases/download/R_2_6_3/expat-2.6.3.tar.bz2"
...
SDL2_URL="https://libsdl.org/release/SDL2-2.30.8.tar.gz"
SDL2_DIR="SDL2-2.30.8"
