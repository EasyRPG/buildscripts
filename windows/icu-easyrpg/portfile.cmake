...
# EASYRPG CUSTOM
set(CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS} --with-data-packaging=static")
# EASYRPG END
...
# Handle copyright
# EASYRPG CUSTOM
file(COPY ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/icu-easyrpg)
file(RENAME ${CURRENT_PACKAGES_DIR}/share/icu-easyrpg/LICENSE ${CURRENT_PACKAGES_DIR}/share/icu-easyrpg/copyright)
# EASYRPG END
